...
class PrinterRepository {
  ...
  Future<List<PrinterModel>> getAll(
      {bool showLoading = true, String? shopId}) async {
    var data = await service.getAll(showLoading: showLoading, shopId: shopId);
    var items =
        List.castFrom(data).map((v) => PrinterModel.fromJson(v)).toList();
    return items;
  }
